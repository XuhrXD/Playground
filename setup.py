...
setup(
    ...
    description='A Computer Security Education Tool',
    long_description=long_description,

    # The project's main homepage.
    url='https://github.com/CrimsonVista/Playground3',

    # Author details
    author='Seth James Nielson',
    author_email='sethjn@gmail.com',
    ...
    keywords='computer security education networking',

    package_dir = {'': "src"},

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=find_packages("src", exclude=['deploy','tests']),
